...
import CommandInterceptor from '@salman65/diagram-js/lib/command/CommandInterceptor';

import {
  getNewAttachPoint
} from '@salman65/diagram-js/lib/util/AttachUtil';
...
import {
  delta
} from '@salman65/diagram-js/lib/util/PositionUtil';
